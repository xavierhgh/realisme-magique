...
function Footer() {
  return (
    <footer className="p-5 my-6 border-t border-accentuation">
      <img src={logoentier} alt="Logo Entier" className="mx-auto w-2/3 my-4" />
      <div className="flex flex-col items-center">
        <h4>Réseaux sociaux</h4>
        <ul className="text-more flex flex-col justify-center gap-2 my-4">
        {RS.map((item, index) => (
